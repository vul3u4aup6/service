...
if (isset($_POST['createBtn'])) {
		...
		if($_POST['className'] != '' ){
			...
			$sql = 'INSERT INTO cooperation_detail(cd_title) VALUES ("'.$name.'")';
					...
					<div>
						...
						<form action="#" method="post">
							<div class="form-group">
								<label>機構名稱</label>
								<input type="text" class="form-control" placeholder="機構名稱" name="className" id="class_name" value="<?=(isset($_SESSION['tmp_class_name']))?$_SESSION['tmp_class_name']:''?>" required>
							</div>
