...
if (isset($_POST['createBtn'])) {
		...
		if($_POST['className'] != '' ){
			...
			$sql = 'INSERT INTO evaluation(e_title,e_pdfpath,e_time,e_content,e_remarks) VALUES ("'.$name.'","'.$pdf.'","'.$catagory.'","'.$content.'","'.$remark.'")';
					...
					<div>
						...
						<form action="#" method="post" enctype="multipart/form-data">
							<div class="form-group">
								<label>評估表格名稱</label>
								<input type="text" class="form-control" placeholder="評估表格名稱" name="className" id="class_name" value="<?=(isset($_SESSION['tmp_class_name']))?$_SESSION['tmp_class_name']:''?>" required>
							</div>
							<div class="form-group">
								<label>評估表格時程</label>
							...
							<div class="form-group">
								<label>評估表格內容</label>
								<input type="text" class="form-control" placeholder="評估表格內容" name="content" value="" required >
							</div>
							<div class="form-group">
								<label>評估表格備註</label>
								<input type="text" class="form-control" placeholder="評估表格備註" name="remark" value="" required >
							</div>
							<div class="form-group">
							<label>檔案上傳</label>
