...
$show = TRUE;
$sql = 'SELECT * FROM feature_learning';
					...
					<tbody>
						...
						foreach ($classArray as $key => $value) {
							...
							<tr class="bk_list">
								...
								<td>
									<form method="post" action="feature_learningUpdate.php" style="display: inline;">
