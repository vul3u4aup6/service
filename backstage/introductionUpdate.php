...
if (isset($_POST['updateBtn'])) {
	$id = $_POST['id'];
	// 撈該筆資料
	$sql = 'SELECT * FROM resultint WHERE `re_id` = "'.$id.'"';
...
if(isset($_POST['saveBtn'])){
	if($_POST['content'] != ''){
		...
		$name = $_POST['content'];
			...
			$sql = 'UPDATE resultint SET `re_content` = "'.$name.'" WHERE `re_id` = "'.$id.'"';
					...
					<div>
						<form action="#" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label>消息內容</label>
								<textarea rows="10" class="form-control" id ="charArea" name="content"><?=(isset($name))?$name:''?></textarea>
							</div>
