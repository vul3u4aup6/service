...
if (isset($_POST['createBtn'])) {
		...
		if($_POST['className'] != '' ){
			...
			$sql = 'INSERT INTO onelecture(ol_title,ol_link,ol_class) VALUES ("'.$name.'","'.$pdf.'","'.$catagory.'")';
					...
					<div>
						...
						<form action="#" method="post" enctype="multipart/form-data">
							<div class="form-group">
								<label>標題</label>
								<input type="text" class="form-control" placeholder="標題" name="className" id="class_name" value="<?=(isset($_SESSION['tmp_class_name']))?$_SESSION['tmp_class_name']:''?>" required>
							</div>
							<div class="form-group">
								<label>辦法分類</label>
