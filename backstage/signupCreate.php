...
if (isset($_POST['createBtn'])) {
		...
		if($_POST['className'] != '' ){
			...
			$pdf = upload_file_by_signup();
	
			if($pdf != FALSE){
				
			
			$level=$_POST['classNumber'];
			$sql = 'INSERT INTO signup(si_title,si_pdfpath) VALUES ("'.$name.'","'.$pdf.'")';
			...
			<div class="row">
				...
				<div class="col-md-9">
					...
					<ol class="breadcrumb">
						...
						<li><a href="signup.php">報名表格</a></li>
						<li class="active">新增報名表格</li>
					</ol>
					<div>
						<?php
						if (!empty($error)) {
						...
						<form action="#" method="post" enctype="multipart/form-data">
							<div class="form-group">
								<label>報名表格名稱</label>
								<input type="text" class="form-control" placeholder="報名表格名稱" name="className" id="class_name" value="<?=(isset($_SESSION['tmp_class_name']))?$_SESSION['tmp_class_name']:''?>" required>
							</div>
