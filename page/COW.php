  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar" >
        ...
        <div class="article" >
          <p style="font-size:20px"><strong>工作業務</strong></p><div class="clr"></div><p/>
         <hr>
		 <br>
		  <p style="font-size:16px"><strong>本中心業務執掌如下：</strong></p><div class="clr"></div><p/>
          <img src="images/graph_07-03.jpg"/>
