  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<p style="font-size:20px"><strong>課程。社區服務申請流程</strong></p><div class="clr"></div><p/>
 <hr>

          　<div class="text">
            <p>&nbsp;&nbsp; &nbsp;　一、本校「服務學習」學生申請服務機構，為一般申請及「特殊申請」兩種方式。
			<p>1.1「一般申請」：凡修習本課程之學生，請於每學期公告之期限內，至服務學習網站進行選擇。進入「<a href="http://www.service-learning.pu.edu.tw:8080/Volunteer/login.jsp">大一服務學習機構選填系統</a>」。</p>
			<p>1.2「特殊申請」：可分為「<strong>不便從事社區服務</strong>、「<strong>返鄉服務</strong>」以及「<strong>社團服務</strong>」，欲申請者須於開學第二週前（詳見公告）至中心申請，符合資格的學生請參考「特殊申請流程」</p>
			<br>
            <br>
            </p>
          </div>
			
			<img src="images/graph_02-05-04.gif">
        </div>
      </div>
      <div class="sidebar">
       ...
       <div class="gadget">
          ...
          <ul class="sb_menu" style="list-style:circle">
            ...
            <li style="font-size:16px"><a href="#">師資陣容</a></li>
