    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article" style="width:700px">
         <p style="font-size:20px"><strong>服學辦法</strong></p>
          　　　　　　　　　　　　　　
		   <p style="font-size:16px"><strong>施行細則</strong></p>
		  ...
		  <thead>
			...
			<?php 
			$i=1;
			$sql="Select * from onelecture where ol_class='施行細則' order by ol_id DESC";
			$result=mysqli_query($conn,$sql);
			while($row=mysqli_fetch_assoc($result)){?>
				<tr>
				<td><?php echo $i++;?></td>
				<td style="text-align:center"><a href="<?php echo $row['ol_link'];?>"><?php echo $row['ol_title'];?></a></td>
			...
			<br/>
			<p style="font-size:16px"><strong>特色服務學習辦法</strong></p><div class="clr"></div><p/>
		  <table class="customer_table" style="background-color:#FF9933;">
		  <thead>
			<th>編號</th>
			<th style="width:80%;text-align:center">名稱</th>
			...
			<?php 
			$i=1;
			$sql="Select * from onelecture where ol_class='特色服務學習辦法' order by ol_id DESC";
			$result=mysqli_query($conn,$sql);
			while($row=mysqli_fetch_assoc($result)){?>
				<tr>
				<td><?php echo $i++;?></td>
