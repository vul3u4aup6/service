    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article" style="width:700px">
         <p style="font-size:20px"><strong>特色服務學習辦法</strong></p>
          　<hr>　　　　　　　　　　　　　
		  <?php $sql="Select * from feature_learning";
		  $result=mysqli_query($conn,$sql);
		  $row=mysqli_fetch_assoc($result);?>
          <p style="text-align:center"><font size="4"><strong><?php echo $row['fl_title'];?></strong></font></p>
		  <p style="text-align:right"><?php echo $row['fl_todaypass'];?></p>
		  <?php echo $row['fl_content'];?>
		  <p style="text-align:right">
		  <?php echo $row['fl_oldpass'];?>
		  </p>
        </div>
      </div>
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu" style="list-style:circle">
            ...
            <li style="font-size:16px"><a href="FSR.php">施行細則</a></li>
			<li style="font-size:16px"><a href="FSSR.php">特色服務學習辦法</a></li>
