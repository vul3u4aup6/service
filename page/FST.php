    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article" style="width:700px">
          <p style="font-size:20px"><strong>課程相關表格</strong></p><div class="clr"></div><p/>
		  <hr>
		  
		  <table class="customer_table" style="background-color:	#97CBFF;">
		  <thead>
			<th>編號</th>
			<th style="width:60%">章則辦法</th>
			<th style="width:20%">檔案下載</th>
			...
			while($row=mysqli_fetch_assoc($result)){?>
				...
				<td><a href="<?php echo $row['ct_pdfpath'];?>" download="<?php echo $row['ct_title'];?>">download</a></td>
			...
			<?php }?>
				 ...
				 <p style="text-align:right"><a href="FST.php">(TOP)</a></p>
        </div>
      </div>
      <div class="sidebar">
