    ...
    <div class="content_resize">
      <div class="mainbar" >
        ...
        <div class="article" style="margin-left:1%;width:700px">
          <p style="font-size:20px"><strong>線上學堂</strong></p><div class="clr"></div><p/>
          <hr>
		  <br/>
			<div style="width:100%;collapse:collapse">
			<?php $sql="Select * from results where r_class='線上學堂'";
		  ...
		  <p style="text-align:right"><a href="RVC.php">(TOP)</a></p>
        </div>
      </div>
      <div class="sidebar">
