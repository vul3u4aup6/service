    ...
    <div class="content_resize">
      <div class="mainbar" >
        ...
        <div class="article" style="margin-left:1%;width:700px">
          <p style="font-size:20px"><strong>國際志工</strong></p><div class="clr"></div><p/>
          <hr>
		  <br/>
			<div style="width:100%;collapse:collapse">
			<?php $sql="Select * from results where r_class='國際志工'";
			$result=mysqli_query($conn,$sql);
			while($row=mysqli_fetch_assoc($result)){?>
				<div style="width:32%;display:inline-block;border:1px solid black;text-align:center;margin-top:1%;height:300px">
				<a href="<?php echo $row['r_videourl'];?>" target="_blank" ><img src="<?php echo $row['r_image'];?>"  style="width:180px;height:210px;margin-left:5%"></a><br/><br/><br/><br/><br/><br/><br/><br/><br/>
				
				<p style="font-size:20px;text-align:center;background-color:#DDDDFF;"><?php echo $row['r_title'];?></p>
				</div>
			<?php }?>
				
			</div>
		  <p style="text-align:right"><a href="RVI.php">(TOP)</a></p>
        </div>
      </div>
      <div class="sidebar">
